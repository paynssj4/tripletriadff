from PyQt5.QtWidgets import QApplication, QWidget, QVBoxLayout, QHBoxLayout, QLabel, QLineEdit, QPushButton, QTextEdit, QListWidget, QInputDialog, QMessageBox, QTabWidget, QScrollArea, QFrame, QCheckBox
...
class IRCClient(QWidget):
    ...
    def display_selected_cards(self):
        ...
        combined_image = QImage(500, 150, QImage.Format_ARGB32)
