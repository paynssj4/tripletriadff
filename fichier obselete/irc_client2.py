...
from card import Card # Importer la classe Card et la fonction create_initial_deck
...
def open_image(image_name):
    ...
    try:
        ...
        logging.error(f"L'image {image_name} n'a pas été trouvée dans le dossier 'img'.")
        return None
